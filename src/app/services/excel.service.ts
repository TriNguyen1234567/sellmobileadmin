...
export class ExcelService {
  ...
  public invoiceReport(invoice_id: number): void {
    this.networkService.getInvoiceReport(invoice_id).subscribe((bufferResponse: ArrayBuffer) => {
      this.saveAsExcelFile(bufferResponse, `InvoiceReport_${invoice_id}`);
    });
  }
